...
def main():
    ...
    drive.on_red_up = lambda state: drive_forward(state, robot)
    drive.on_red_down = lambda state: drive_backward(state, robot)
    drive.on_blue_up = lambda state: turn_left(state, robot)
    drive.on_blue_down = lambda state: turn_right(state, robot)
    ...
    arm.on_blue_down = lambda state: handle_shutdown(state, dc)
