...
Authors: David Fisher and Rebecca, Cheryl, Sydney.
...
def main():
    ...
    btn.on_backspace = lambda state:handle_shutdown(True,False)
...
# TODO: 7. Call over a TA or instructor to sign your team's checkoff sheet
